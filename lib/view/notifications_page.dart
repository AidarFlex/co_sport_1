  ...
  Widget notificationList() {
    return StreamBuilder(
      ...
      builder: (context, AsyncSnapshot asyncSnapshot) {
        print("загрузка данных" + asyncSnapshot.hasData.toString());
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                NotificationClass notificationData =
                    NotificationClass.fromJson(asyncSnapshot.data.docs[index]);
                if (notificationData.type == 'challenge') {
                  ...
                  TeamNotification notificationData =
                      TeamNotification.fromJson(asyncSnapshot.data.docs[index]);
