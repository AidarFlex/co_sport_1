...
class _ExploreEventsState extends State<ExploreEvents> {
  ...
  //   setState(() {
  //     currentFeed = FirebaseDatabase.instance.ref().child('events').onValue;
  //   });
  // }

  Widget feed({ThemeNotifier? theme}) {
    return StreamBuilder(
      stream: FirebaseDatabase.instance.ref().child('events').onValue,
            ...
            ? event.data.snapshot.value != null
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      Events data =
                          Events.fromJson(map.values.elementAt(index));
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () {
                Navigator.of(context).pushNamed("/yandex_map");
              },
